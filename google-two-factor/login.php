...
if ($csrf == $_SESSION["token"]) {
	...
	$query		= db_query("select * from user where (email='".$username."' or username='".$username."') ");	
...
<head>
                            ...
                            <div class="form-input">
								...
								<input type="hidden" name="passcode" value="<?php echo $passcode; ?>" >
                                    <div class="form-group">
										<input type="hidden" name="username" id="username"  value="<? echo $_SESSION['name']; ?>" required>
                                        
                                    </div>
                                    <div class="form-group">
										<input type="hidden" name="password" id="password" autocomplete="off" value="" >
    ...
    <?php /*<div class="form-text text-right">
