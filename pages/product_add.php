...
include('../dist/includes/dbcon.php');
	...
	$query2=mysqli_query($con,"select * from product where prod_name='$name' and branch_id='$branch'")or die(mysqli_error($con));
		...
		{	
			...
			mysqli_query($con,"INSERT INTO product(prod_name,prod_desc,uom,weight,branch_id,volume,user_id,category)
			VALUES('$name','$desc','$uom','$weight','$branch','$volume','$id','$category')")or die(mysqli_error($con));
