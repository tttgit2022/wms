...
<body>
    ...
    <h5><b><?php echo $row['branch_name'];?></b> </h5>  
                  		  <h5><b> TAQ-Royal Fan Warehouse Recieved Items List as on, <?php echo date("M d, Y");?></b></h5>
                  
				  <a class = "btn btn-success btn-print" href = "" onclick = "window.print()"><i class ="glyphicon glyphicon-print"></i> Print</a>
							<a class = "btn btn-primary btn-print" href = "final_barcode.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back</a>   
...
<td><?php echo $productResult[$key]["asn_qty"];  
$qt1=$qt1+$productResult[$key]["asn_qty"];?></td>
<td><?php echo $productResult[$key]["asn_balance"];  
$qt2=$qt2+$productResult[$key]["asn_balance"];?></td>
            ...
            ?>
<tr> <td></td><td></td><td><b> Total Items </b></td> <td><b><?php echo $qt; ?> </b></td> <td><b><?php echo $qt1; ?> </b></td> <td><b><?php echo $qt2; ?> </b></td></tr>               
