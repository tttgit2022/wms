        ...
        <div >
          ...
          <section class="content-header">
            <h1>
              ...
              <a class="btn btn-lg btn-warning" href="index_inbound.php">Inbound Report</a>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <h3 class="box-title">Inbound List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
		...
		$query=mysqli_query($con,"SELECT * FROM `stockin` INNER JOIN product on product.prod_id=stockin.prod_id ORDER by stockin.date DESC") or die(mysqli_error());
