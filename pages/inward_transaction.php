        ...
        <div >
          ...
          <section class="content-header">
            <h1>
              ...
              <a class="btn btn-lg btn-warning" href="index5.php">ASN Format</a>
              
            </h1>

            

            <h5 class="box-title">Advance Shipping Notice (ASN) File Upload   </h5> 
...
<div align="right">
<form action="inward_add.php" method="POST" enctype="multipart/form-data">
<input type="text" name="rec_dnno"  placeholder="A.S.N Document No." required>
<button type="submit" name="cash" class="btn btn-primary mt-3" >Save A.S.N</button>
	      ...
	      <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Advance Shipping Notice (ASN) </h3>
                </div>
                <div class="box-body">
                  <!-- Date range -->
					...
					<div class=" col-md-2">
						<div class="form-group">
							...
							<div class="input-group">
							  <input type="number" class="form-control pull-right" id="date" name="qty" placeholder="Quantity" tabindex="2" value="1" min="0" required>
							</div><!-- /.input group -->
						</div><!-- /.form group -->
					 </div>
					<div class="col-md-2">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Update Inbound Details</h4>
              </div>
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="inward_update.php" enctype='multipart/form-data'>
					<input type="hidden" class="form-control" name="cid" value="<?php echo $cid;?>" required>  	
          ...
          <div class="form-group">
					...
					<div class="col-lg-9">
					  <input type="number" class="form-control" id="price" name="qty" value="<?php echo $row['qty'];?>" min="0" required>  
          </div>
				</div>

        <?php /*
        <div class="form-group">
					<label class="control-label col-lg-3" for="price">Serial No.</label>
					<div class="col-lg-9">
					<input type="text" class="form-control" id="price" name="sno" value="<?php echo $row['serial_no'];?>" required>  
				 </div>
				</div>
				*/ ?>
              </div><br>
...
<div id="delete<?php echo $row['temp_trans_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
        <form class="form-horizontal" method="post" action="inward_transactiondel.php" enctype='multipart/form-data'>
          <input type="hidden" class="form-control" name="cid" value="<?php echo $cid;?>" required>   
          <input type="hidden" class="form-control" id="price" name="id" value="<?php echo $row['temp_trans_id'];?>" required>  
