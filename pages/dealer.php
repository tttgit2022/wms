...
<html>
  <head>
    ...
    <title>Dealer | <?php include('../dist/includes/title.php');?></title>
      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content-header">
            ...
            Download Consignee List <form action="index_dealer.php" method="POST" enctype="multipart/form-data">
...
<div id="updateordinance<?php echo $row['cust_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="dealer_update.php" enctype='multipart/form-data'>
				...
				<div class="form-group">
					...
					<div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['cust_id'];?>" required>  
					  <input type="text" class="form-control" id="name" name="cust_name" value="<?php echo $row['cust_name'];?>" required>  
					</div>
				</div> 
        <br>
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="add" value="<?php echo $row['cust_address'];?>" required>  
          </div>
        </div> 
		<div class="form-group">
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">E-Mail Address</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="email" value="<?php echo $row['cust_email'];?>" required>  
          </div>
        </div> 	
...
<div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
        <form class="form-horizontal" method="post" action="dealer_add.php" enctype='multipart/form-data'>
        
                
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Consignee Name</label>
          <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" required>  
            <input type="text" class="form-control" id="name" name="cust_name" placeholder="Name" required>  
          </div>
        </div> 
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Consignee Address</label>
          <div class="col-lg-9">
            <textarea class="form-control" id="price" name="cust_address" placeholder="Address"></textarea>  
          </div>
        </div>

	<div class="form-group">
          <label class="control-label col-lg-3" for="price">Consignee Contact #</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="contact" placeholder="Contact #" required>   
          </div>
        </div>
	
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Consignee E-Mail</label>
          <div class="col-lg-9">
