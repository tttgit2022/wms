...
$productResult = $db_handle->runQuery("SELECT `prod_id`,`prod_name`,`prod_desc`,`prod_qty`, zone FROM `product` where prod_qty>0 order by prod_qty desc");
...
<td><?php echo $sno ?> </td>    
 ...
 <td> 0</td> 
            ...
            ?>
    <tr>
  <td></td><td></td><td></td><td> <b>Total Products</td><td> <b><?php echo $tot; ?> </b></td>      <td></td>
    </tr>        
