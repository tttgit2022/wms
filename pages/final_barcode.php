        ...
        <div >
          ...
          <section class="content-header">
            <h1>
              ...
              <a class="btn btn-lg btn-warning" href="bar.php">Bar Code Recieve</a>
              
              </h1>

Final List <form action="index_final.php" method="POST" enctype="multipart/form-data">
...
?>
       ...
       <?php $query0=mysqli_query($con,"select * from product  where branch_id='$branch' and prod_id='$pd' ")or die(mysqli_error());
		while($row0=mysqli_fetch_array($query0)){ ?>
                        ...
                        <td><?php echo $row['unit_damage']; ?></td>
                        <td><?php echo $row['pk_damage']; } ?></td>
...
<div id="updateordinance<?php echo $row['stockin_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Zone</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="zone" value="<?php echo $row5['zone']; ?>" required>  
          </div>
        </div> 
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Packing Damage</label>
          <div class="col-lg-8">
            <input type="text" class="form-control" id="name" name="pk_damage" value="<?php echo $row['pk_damage']; ?>" required>  
          </div>
        </div> 

        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Unit Damage</label>
          <div class="col-lg-8">
            <input type="text" class="form-control" id="name" name="unit_damage" value="<?php echo $row['unit_damage']; }?>" required>  
          </div>
        </div> 
...
<div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
 ...
 <!--end of modal--> 
    ...
    <?php /*
    <div>
              <form class="form-horizontal" method="post" action="search_bar.php" enctype='multipart/form-data'>
