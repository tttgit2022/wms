      ...
      <div class="content-wrapper">
        <div >
          ...
          <section class="content-header">
            <h1>
              <a class="btn btn-lg btn-warning" href="final_barcode.php">Back</a>
              
              </h1>

<form action="index_damage.php" method="POST" enctype="multipart/form-data">
<button type="submit" name="load_excel_data" class="btn btn-primary mt-3">Damage List</button>
            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <h3 class="box-title">Damage Item List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Update Damage Items Details</h4>
              </div>
        ...
        <div class="col-lg-9"> <b>Item Id - Name </b> <?php echo '             ' . $pd1 . '-' . $row5['prod_name'] . '  - ' . 'QTY ' . ' - ' . $row['qty'];}?>
        ...
        <br>
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="pk_qty" value="<?php echo $row['pk_damage'];?>" required>  
          </div>
        </div> 
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="unit_qty" value="<?php echo $row['unit_damage'];?>" required>  
          </div>
        </div> 
