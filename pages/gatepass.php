        ...
        <div >
	      ...
	      <div class="col-md-4">
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <!-- Date range -->
                  <form method="post" action="gatepass_add.php" enctype="multipart/form-data">
			 ...
			 include('../dist/includes/dbcon.php'); ?>
                  ...
                  <div class="form-group">
                    <label for="date">ASN #</label>
                    <div class="input-group col-md-12">
                      <select class="form-control select2" name="grn_no" required>    
                      <option value=""></option>
		       
      <?php
				$query2=mysqli_query($con,"SELECT * FROM `stockin` WHERE `final`='1' and `branch_id`='1' and gatepass_id=0 group by rec_dnno")or die(mysqli_error());
		      ...
		      <?php }?>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <textarea name="remarks"  placeholder="Remarks" cols="48" rows="5"></textarea>
...
<?php
		...
		$query=mysqli_query($con,"SELECT * FROM `gatepass` inner JOIN transporter on transporter.trns_id=gatepass.trns_name ORDER by gatepass.gatepass_id DESC") or die(mysqli_error());
		while($row=mysqli_fetch_array($query)){
		
?>
                      <tr>
			                  <td><?php echo $row['grn_no'];?>
                        <form action="recieptgrn.php" method="POST" name="sub">
