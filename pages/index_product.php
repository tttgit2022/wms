...
$productResult = $db_handle->runQuery("SELECT `prod_id`,`prod_name`,`prod_desc`,`prod_qty`,zone FROM `product`");
...
<body>
    ...
    <h5><b><?php echo $row['branch_name'];?></b> </h5>  
				  ...
				  <a class = "btn btn-success btn-print" href = "" onclick = "window.print()"><i class ="glyphicon glyphicon-print"></i> Print</a>
							<a class = "btn btn-primary btn-print" href = "product.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back</a>   
...
<td><?php echo $productResult[$key]["prod_qty"];  
$qt=$qt+$productResult[$key]["prod_qty"];?></td>
