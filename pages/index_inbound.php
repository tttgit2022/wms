...
$productResult = $db_handle->runQuery("SELECT * FROM `stockin` INNER JOIN product on product.prod_id=stockin.prod_id order by stockin.date Asc");
...
<body>
    ...
    <h5><b><?php echo $row['branch_name'];?></b> </h5>  
                  		  <h5><b> TAQ-Royal Fan Warehouse Inbound List as on, <?php echo date("M d, Y");?></b></h5>
...
<td><?php echo $productResult[$key]["rec_dnno"]; ?> </td>    
 ...
 <td><?php echo $productResult[$key]["qty"]; $qt=$qt+$productResult[$key]["qty"]; ?></td>  
 <td><?php echo $productResult[$key]["date"]; ?></td>  
 <td><?php echo $productResult[$key]["truck_no"]; ?></td>  
            ...
            ?>
   <tr> <td> </td><td></td><td></td><td><b>Total Inbound Products </b></td><td> <b><?php echo $qt; ?></b></td><td></td><td></td></tr>         
